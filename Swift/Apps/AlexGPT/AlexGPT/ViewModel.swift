...
final class ViewModel: ObservableObject{
    ...
    @Published var messages: [MessageChatGPT] = [.init(text: "¡Hola Alejandro! Soy tu asistente, estoy aqui para contestarte todas las preguntas que tengas", role: .system)]
    
    @Published var currentMessage: MessageChatGPT = .init(text: "", role: .assistant)
    

    
    var openAI = SwiftOpenAI(apiKey: "Introduce tu API Key aqui")
